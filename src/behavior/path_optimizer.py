...
_VISUAL_LANE_REENTRY_GAIN = 0.80
_VISUAL_LANE_REENTRY_MAX_SHIFT_M = 0.14
...
_VISUAL_LANE_REENTRY_DERIVED_SINGLE_LINE_GAIN = 0.50
...
try:
    from config import (
        BEHAVIOR_VISUAL_ROUTE_BLEND_SINGLE_LINE_MAX_OBSERVATION_M
        as _VISUAL_ROUTE_BLEND_SINGLE_LINE_MAX_OBSERVATION_M,
        BEHAVIOR_VISUAL_ROUTE_BLEND_SINGLE_LINE_MAX_SHIFT_M
        as _VISUAL_ROUTE_BLEND_SINGLE_LINE_MAX_SHIFT_M,
        BEHAVIOR_VISUAL_ROUTE_BLEND_SINGLE_LINE_MIN_SHIFT_M
        as _VISUAL_ROUTE_BLEND_SINGLE_LINE_MIN_SHIFT_M,
        BEHAVIOR_VISUAL_ROUTE_BLEND_SINGLE_LINE_WEIGHT
        as _VISUAL_ROUTE_BLEND_SINGLE_LINE_WEIGHT,
    )
except Exception:
    _VISUAL_ROUTE_BLEND_SINGLE_LINE_WEIGHT = 0.45
    _VISUAL_ROUTE_BLEND_SINGLE_LINE_MAX_SHIFT_M = 0.08
    _VISUAL_ROUTE_BLEND_SINGLE_LINE_MAX_OBSERVATION_M = 0.18
