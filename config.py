...
LANE_VISUAL_PRIMARY_SINGLE_LINE_ENABLED = True
LANE_VISUAL_PRIMARY_SINGLE_LINE_MIN_QUALITY = 0.85
LANE_VISUAL_PRIMARY_MAP_AUTHORITY_DISTANCE_M = 0.25
...
TRACKING_IMU_VISUAL_LOST_YAW_CORRECTION_ENABLED = True
TRACKING_IMU_VISUAL_LOST_TWO_LINE_MIN_QUALITY = 0.80
TRACKING_IMU_VISUAL_LOST_MIN_SPEED_MPS = 0.03
TRACKING_IMU_VISUAL_LOST_MIN_GAIN = 0.35
TRACKING_IMU_VISUAL_LOST_MAX_GAIN = 0.70
...
TRACKING_VISUAL_LANE_MAP_ALIGNMENT_BLEND = 1.00
...
TRACKING_CHAMFER_ALIGNMENT_MIN_POINTS = 12
